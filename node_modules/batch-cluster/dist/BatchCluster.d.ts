...
import { BatchClusterEmitter, BatchClusterEvents, ChildEndReason } from "./BatchClusterEmitter";
...
export type { BatchClusterEmitter, BatchClusterEvents, BatchProcessOptions, ChildEndReason as ChildExitReason, Parser, WhyNotHealthy, WhyNotReady, };
/**
...
export declare class BatchCluster {
     ...
     */
    readonly on: <E extends keyof BatchClusterEvents>(eventName: E, listener: (...args: BatchClusterEvents[E] extends infer T ? T extends BatchClusterEvents[E] ? T extends (...args: unknown[]) => void ? unknown[] : never : never : never) => void) => BatchClusterEmitter;
    /**
     * @see BatchClusterEvents
     * @since v9.0.0
     */
    readonly off: <E extends keyof BatchClusterEvents>(eventName: E, listener: (...args: BatchClusterEvents[E] extends infer T ? T extends BatchClusterEvents[E] ? T extends (...args: unknown[]) => void ? unknown[] : never : never : never) => void) => BatchClusterEmitter;
    get ended(): boolean;
    /**
